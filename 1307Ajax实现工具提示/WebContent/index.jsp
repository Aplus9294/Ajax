...
<%
ResultSet rs=conn.executeQuery("select id,bookName,category,description from tb_book order by id");
int new_ID=0;
String new_bookname="";
String new_category="";
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="CFCFCF">
         <%       int s=0;
				  while(rs.next()){
					...
					new_category=rs.getString(3);
					new_description=rs.getString(4);
				  	if(s==0){
				  %>
        <tr>
          ...
          <table width="0" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="95" align="center"><img src="images/book/<%=new_bookname%>.jpg" width="143" height="200" border="1"></td>
              </tr>
              <tr>
                <td height="22" align="center"><a href="#"> <%=new_bookname%></a></td>
              </tr>
              <tr>
                <td height="20" align="center">种类：<%=new_category%></td>
              </tr>
            </table>
           </td>
          <%}else{%>
